...
export const ColorPicker = ({ onSelectColor, triggerIcon, label }: ColorPickerProps) => {
  ...
  const colorPalette = [
    ...
    // Row 2: Vibrant colors - main color spectrum
    ['#ff0000', '#ff8000', '#ffff00', '#80ff00', '#00ff00', '#00ff80', '#00ffff', '#0080ff', '#0000ff', '#8000ff'],
    
    // Rows 3-7: Shades of the colors above (moving from lighter to darker)
    
    // Row 3: Very light shades

  ...
  if (message.isUser) {
    return (
      <div className="flex justify-end space-x-2">
        <div
          className="max-w-[80%] sm:max-w-[75%] md:max-w-[70%] bg-white dark:bg-gray-900 rounded-2xl p-3 sm:p-4 shadow-lg transform hover:scale-[1.01] transition-all duration-200"
          style={{
            boxShadow: darkMode

...
const Search = () => {
  ...
  return (
    <motion.div 
      className="w-full max-w-[95%] sm:max-w-xl mx-auto px-2 sm:px-4"
    ...
    >
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-16 sm:pr-24 bg-gray-50/80 dark:bg-gray-800/80 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-gray-700 dark:text-gray-200 dark:placeholder-gray-400 shadow-sm backdrop-blur-sm"
